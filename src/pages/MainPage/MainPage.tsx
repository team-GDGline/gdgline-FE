...
import { LogOutIcon, Trash2Icon, MenuIcon, CameraIcon } from "lucide-react";
...
const MainPage: React.FC = () => {
  ...
  return (
    <Wrapper>
      <Flex width="100%" justifyContent="flex-end" p={1}>
        <Menu>
          ...
          <MenuList>
            ...
            <MenuItem
              icon={<Image src={fishIcon} boxSize="1.5em" />}
              isDisabled
      ...
      >
        <Text fontSize="3xl" color="#152972">
          물
        </Text>
        <Text fontSize="3xl" color="#152972">
          멍
      ...
      <Text mt="20px" fontSize="1xl" color="#666666">
        물고기를 모아 나만의 아쿠아리움을 완성하세요
      </Text>
      <Aquarium></Aquarium>
      <BottomLayout>
        <Button
